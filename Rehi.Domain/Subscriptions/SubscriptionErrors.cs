...
public static class SubscriptionErrors
{
    public static Error AlreadyExists =>
        new("Subscription.AlreadyExists", "Subscription already exists", ErrorType.Conflict);
    ...
    public static Error InvalidSubscription =>
        new("Subscription.InvalidSubscription", "Invalid Subscription", ErrorType.Conflict);
